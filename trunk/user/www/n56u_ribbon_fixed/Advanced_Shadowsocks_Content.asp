...
function initial(){
	...
	var o3 = document.form.ss_obfs;
	var o4 = document.form.ss_obfs_param;
	var o5 = document.form.ss_lower_port_only;
	o1.value = '<% nvram_get_x("","ss_method"); %>';
	o2.value = '<% nvram_get_x("","ss_mode"); %>';
	o3.value = '<% nvram_get_x("","ss_obfs"); %>';
	o4.value = '<% nvram_get_x("","ss_obfs_param"); %>';
...
function submitInternet(v){
	showLoading();
	document.Shadowsocks_action.action = "Advanced_Shadowsocks_action.asp";
                            ...
                            <div class="round_bottom">
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr> <th colspan="2" style="background-color: #E3E3E3;"><#menu5_13_1#></th> </tr>
                                        ...
                                        <tr> <th colspan="2" style="background-color: #E3E3E3;"><#menu5_13_3#></th> </tr>
										
                                        <tr> <th width="50%"><#menu5_13_4#></th>
                                            <td>
                                                <input type="text" maxlength="64" class="input" size="64" name="ss_server" value="<% nvram_get_x("","ss_server"); %>" />
                                            </td>
                                        </tr>

                                        <tr> <th width="50%"><#menu5_13_5#></th>
                                            <td>
                                        ...
                                        <tr> <th width="50%"><#menu5_13_18#></th>
                                            <td>
                                                <select name="ss_lower_port_only" class="input" style="width: 200px;">
                                                    <option value="0" ><#menu5_13_18_0#></option>
                                                    <option value="1" ><#menu5_13_18_1#></option>
                                                    <option value="2" ><#menu5_13_18_2#></option>
                                                </select>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th width="50%"><#menu5_13_24#></th>
                                            <td style="border-top: 0 none;" colspan="2">
                                                <input type="button" id="btn_connect_3" class="btn btn-info" value=<#menu5_13_25#> onclick="submitInternet('Update_gfwlist');">
                                            </td>
                                        </tr>

										<tr> <th width="50%"><#menu5_13_26#></th>
                                            <td>
                                                <input type="text" maxlength="72" class="input" size="64" name="ss_gfwlist_url" value="<% nvram_get_x("","ss_gfwlist_url"); %>" />
                                            </td>
                                        </tr>

										<tr> <th width="50%"><#menu5_13_27#></th>
                                            <td>
                                                <input type="text" maxlength="72" class="input" size="64" name="ss_unblocked_sites_dns" value="<% nvram_get_x("","ss_unblocked_sites_dns"); %>" />
                                            </td>
                                        </tr>
